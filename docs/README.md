...
| [axiom-simplification-reset-phase-1.md](axiom-simplification-reset-phase-1.md) | Current repository audit, candidate-state contradictions, and concrete simplification plan. |
| [../axiom-state.json](../axiom-state.json) | Authoritative machine-readable accepted, candidate, Labs, phase, and next-action state. |
...
| [task-backlog.md](task-backlog.md) | Historical task backlog and completed roadmap record; not current project-state authority. |
| [axiom-clean-r012-candidate-readiness-plan-2026-07-08.md](axiom-clean-r012-candidate-readiness-plan-2026-07-08.md) | Completed pre-creation readiness record for the now-active, unqualified R012 candidate. |
